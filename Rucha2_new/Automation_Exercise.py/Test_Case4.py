...
driver.find_element(By.XPATH,'//*[@id="header"]/div/div/div/div[2]/div/ul/li[4]')
time.sleep(1)

# 9. Verify that user is navigated to login page
driver.get("https://automationexercise.com/login")

if driver.current_url == "https://automationexercise.com/login":
    print('User is navigated to login page')
else:
    print('User is not navigated to login page')
