...
driver.find_element(
    By.XPATH, '//*[@id="top"]/body/div/div/div[2]/div/div[2]/div[1]/div[3]/div[1]/div[1]/div/select/option[2]').click()
time.sleep(2)

# 6.Verify all products are sorted by name
product_names = driver.find_elements(
    By.XPATH, '//*[@id="top"]/body/div/div/div[2]/div/div[2]/div[1]/div[3]/ul/li[3]/div/h2')
time.sleep(2)
