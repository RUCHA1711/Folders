...
# time.sleep(2)
driver.find_element(By.XPATH,'//*[@id="identifierId"]').send_keys('harshvaddoriya21@gmail.com')
time.sleep(2)
driver.find_element(By.XPATH,'//*[@id="identifierNext"]/div/button/span').click()
time.sleep(2)
driver.implicitly_wait(4)
driver.find_element(By.XPATH,'//*[@id="password"]/div[1]/div/div[1]/input').send_keys('Tagline@123')
time.sleep(2)
...
driver.find_element(By.XPATH,'//*[@id=":to"]').send_keys('rucha.tagline@gmail.com')
time.sleep(2)
